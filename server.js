...
ĐỊNH DẠNG JSON:
{
"fortune": "Nội dung bói (khoảng 110 - 120 từ). BẮT BUỘC sử dụng thẻ <br> để xuống dòng giữa các ý chính để nội dung thoáng và dễ đọc. Mỗi ý nên là một dòng riêng biệt."
}`;
